...
export declare const saturationVapourPressure: (temperature: number) => number;
/**
 ...
 */
export declare const vapourPressureDeficit: (airTemperature: number, leafTemperature: number, relativeHumidity: number) => number;
