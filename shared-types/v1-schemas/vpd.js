...
exports.vapourPressureDeficit = exports.saturationVapourPressure = void 0;
/** Saturation vapour pressure in kPa, by the Tetens formula. */
const saturationVapourPressure = (temperature) => 0.6108 * Math.exp((17.2694 * temperature) / (temperature + 237.3));
exports.saturationVapourPressure = saturationVapourPressure;
/**
 ...
 */
const vapourPressureDeficit = (airTemperature, leafTemperature, relativeHumidity) => (0, exports.saturationVapourPressure)(leafTemperature) - (0, exports.saturationVapourPressure)(airTemperature) * (relativeHumidity / 100);
exports.vapourPressureDeficit = vapourPressureDeficit;
