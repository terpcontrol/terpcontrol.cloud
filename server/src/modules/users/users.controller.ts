...
export class UsersController {
  ...
  public async create(@ZodBody(createUserSchema) body: CreateUser): Promise<AccountResult> {
  ...
  @ApiShape('AccountResult')
  public async update(@Param('id') id: string, @ZodBody(updateUserSchema) body: UpdateUser): Promise<AccountResult> {
