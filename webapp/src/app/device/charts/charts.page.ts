  ...
  public measures = [
    {
      ...
      right: false,
      nav: false,
      types: ['fridge', 'fridge2', 'fan', 'light', 'plug', 'dryer', 'controller', 'headless'],
      max: 30
    },
    // { title: 'AVG', icon: 'temperature', color: '#f00', name: 'avg', txt: 'avg', unit: '°C', enabled: true, right: false, nav: false, types: ['fridge']},
    { title: 'Humidity', icon: 'humidity', color: '#4870c0', name: 'humidity', txt: 'H', unit: '%', enabled: false, right: false, nav: false, types: ['fridge', 'fridge2', 'fan', 'light', 'plug', 'dryer', 'controller', 'headless'], max: 100},
    { title: 'VPD', icon: 'vpd', color: '#50a030', name: 'vpd', txt: 'V', unit: 'kPa', enabled: false, right: false, nav: false, types: ['fridge', 'fridge2', 'fan', 'light', 'plug', 'dryer', 'controller', 'headless'], max: 1.6},
    { title: 'CO2', icon: 'co2', color: '#7a5fb0', name: 'co2', txt: 'CO2', unit: 'ppm', enabled: false, right: false, nav: false, types: ['fridge', 'fridge2', 'plug', 'controller', 'headless'], max: 1},
    { title: 'Leaf Temperature', icon: 'temperature', color: '#b0743c', name: 'leaf_temperature', txt: 'LT', unit: '°C', enabled: false, right: false, nav: false, types: ['controller', 'headless'], max: 30},
    { title: 'PPFD', icon: 'light', color: '#e3a008', name: 'ppfd', txt: 'PPFD', unit: 'µmol/m²/s', enabled: false, right: false, nav: false, types: ['controller', 'headless'], max: 1000},
    { title: 'Heater', icon: 'heating', color: '#c2483c', name: 'out_heater', txt: 'T', unit: '', enabled: false, right: false, nav: false, types: ['fridge', 'fridge2', 'dryer', 'controller', 'headless'], max: 1},
    ...
    { title: 'Dehumidifier', icon: 'dehumidify', color: '#3e8fbf', name: 'out_dehumidifier', txt: 'H', unit: '', enabled: false, right: false, nav: false, types: ['fridge', 'fridge2', 'dryer', 'controller', 'headless'], max: 1},
    { title: 'Fan', icon: 'fan_out', color: '#2e9e8f', name: 'out_fan', txt: 'Fan', unit: '%', enabled: false, right: false, nav: false, types: ['fan'], max: 1},
    { title: 'CO2 Valve', icon: 'co2_valve', color: '#8e6fc0', name: 'out_co2', txt: 'CO2 Valve', unit: ' ticks', enabled: false, right: false, nav: false, types: ['fridge', 'fridge2', 'controller', 'headless'], method: 'sum'},
    { title: 'Lights', icon: 'light', color: '#c8a23c', name: 'out_light', txt: 'Lights', unit: '', enabled: false, right: false, nav: false, types: ['fridge', 'fridge2', 'light', 'controller', 'headless'], max: 100},
